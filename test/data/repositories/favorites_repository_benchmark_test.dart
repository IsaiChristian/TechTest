...
void main() {
  ...
  test(
    'Optimization: verify getJsonList is called only once for repeated fetches',
    () async {
      // Setup mock
      when(
  ...
  test(
    'Optimization: verify addMovieToFavorites updates cache and avoids extra fetches',
    () async {
      ...
      verify(
        mockLocalStorage.setJsonList<MovieEntity>(tKey, [tMovie]),
      ).called(1);
